...
export default function SnippetFullView({ snippet, onClose }: SnippetFullViewProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="w-full md:w-[260px] shrink-0 p-6 flex flex-col gap-5 relative">
        ...
        <div className="pr-6">
          <p className="text-xs text-white/30 uppercase tracking-widest mb-1">Title</p>
          <p className="text-white font-semibold text-base">{snippet.title}</p>
        </div>

        <div>
          <p className="text-xs text-white/30 uppercase tracking-widest mb-1.5">Language</p>
        ...
        {snippet.tags?.length > 0 && (
          <div>
            <p className="text-xs text-white/30 uppercase tracking-widest mb-2">Tags</p>
