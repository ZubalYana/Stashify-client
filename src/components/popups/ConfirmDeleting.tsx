      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[min(calc(100vw-1.5rem),420px)] bg-[#121212] border border-white/10 rounded-2xl p-5 sm:p-6 shadow-2xl"
