  ...
  return (
    <div className="w-full min-w-0 p-4 sm:p-5 lg:p-10 pb-24">
      <div className="flex items-center justify-between gap-3 mb-6">
        <h3 className="text-[22px] sm:text-[24px] lg:text-[20px] font-semibold min-w-0 truncate">Projects</h3>
        <button
      ...
      {projects.length === 0 ? (
        <div className="w-full h-[60vh] flex justify-center items-center">
          <h3 className="opacity-[0.7] text-center text-pretty px-6 max-w-md">No projects yet. Create one to group snippets.</h3>
        </div>
      ) : (
